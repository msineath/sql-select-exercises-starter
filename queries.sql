...
-- your query here
SELECT cities.city, cities.state, cities.population_estimate_2018 FROM cities;
\echo ========= Problem 2.2 ====================================================
\echo
/*
...
-- your query here
SELECT cities.population_estimate_2018 FROM cities WHERE city = 'San Diego'; 
\echo ========= Problem 3.2 ====================================================
\echo
/*
...
*/
 ...
 -- your query here
SELECT cities.city, cities.state, cities.population_estimate_2018 FROM cities WHERE city IN ('Phoenix', 'Jacksonville', 'Charlotte', 'Nashville');
\echo ========= Problem 3.3 ====================================================
\echo
/*
...
-- your query here
SELECT cities.city, cities.state, cities.population_estimate_2018 FROM cities WHERE population_estimate_2018 BETWEEN 800000 AND 900000;
\echo ========= Problem 3.4 ====================================================
\echo
/*
...
-- your query here
SELECT cities.city FROM cities WHERE population_estimate_2018 >= 1000000;
\echo ========= Problem 3.5 ====================================================
\echo
/*
...
-- your query here
SELECT cities.city, (cities.population_estimate_2018 / 1000000) AS population_in_millions FROM cities WHERE state = 'Texas';
\echo ========= Problem 3.6 ====================================================
\echo
/*
...
-- your query here
SELECT cities.city, cities.state, cities.population_estimate_2018 FROM cities WHERE state NOT IN ('New York', 'California', 'Texas');
\echo ========= Problem 3.7 ====================================================
\echo
/*
...
-- your query here
SELECT airports.FAA_id, airports.IATA_id, airports.ICAO_id, airports.name FROM airports WHERE name = 'Chicago O''Hare International Airport'; 
\echo ========= Problem B.2 ====================================================
\echo
/*
...
-- your query here
SELECT TO_CHAR(cities.population_estimate_2018, '999,999,999') FROM cities;
\echo ========= Problem B.3 ====================================================
\echo
/*
